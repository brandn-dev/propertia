...
export const tenantPersonSchema = z.object({
  personId: optionalStringField(64, "Person identifier is invalid."),
  firstName: z
    .string()
    .trim()
  ...
  middleName: optionalStringField(80, "Middle name must be 80 characters or fewer."),
  positionTitle: optionalStringField(
    80,
    "Position or relation must be 80 characters or fewer."
  ),
  contactNumber: optionalStringField(
    32,
    "Contact number must be 32 characters or fewer."
  ),
  email: optionalEmailField,
  address: optionalStringField(240, "Address must be 240 characters or fewer."),
  validIdType: optionalStringField(80, "ID type must be 80 characters or fewer."),
  validIdNumber: optionalStringField(
    80,
    "ID number must be 80 characters or fewer."
  ),
  notes: optionalStringField(240, "Notes must be 240 characters or fewer."),
  isPrimary: z.boolean(),
});
